          ...
          <div>
            <div id="kt_cc_content">
              ...
              <div
                ...
                <router-link
                  v-if="item.customer"
                  :to="{name: 'expert.users.view', params:{id: item.customer.id}}"
                  class="d-flex align-items-center flex-grow-1">
                  <div class="symbol symbol-45px me-5">
                    <img :src="`/u/image-${item.customer.id}.jpg`" alt="">
                  </div>
                  <div class="d-flex justify-content-start flex-column">
                    <span class="text-dark fw-bolder text-hover-primary fs-6">{{ item.customer.name }}</span>
...
export default {
  ...
  setup(){
    ...
    const loadEvents = () => {
      ...
      axios.get('/api/v1/expert/sale/consultations/events', params)
        .then((response) => {
