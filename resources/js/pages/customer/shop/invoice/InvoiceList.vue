            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5">
              ...
              <tr v-for="model in models" :key="model.id" :id="`table-row-${model.id}`">
                ...
                <td>
                  <router-link
                    v-if="model.order"
                    :to="{name: 'customer.orders.view', params: {id: model.order.id}}">
                    #{{ model.order.id }}
                  </router-link>
                </td>
                <!--end::Order=-->
                ...
                <td class="text-end">
                  ...
                  <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-200px py-4" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                      <router-link
                        :to="{name: 'customer.invoices.view', params: {id: model.id}}"
...
export default {
  ...
  setup(){
    ...
    const loadModels = () => {
      ApiService.get('/customer/invoices', {params: params.value})
        .then(({data}) => {
          if(data.success) {
