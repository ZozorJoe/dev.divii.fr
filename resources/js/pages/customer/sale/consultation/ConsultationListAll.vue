...
export default {
  ...
  setup(props){
    ...
    const params = computed(() => {
      ...
      data['with'] = 'expert,model.discipline'
    ...
    const loadModels = () => {
      ApiService.get('/customer/sale/consultations', {params: params.value})
        .then(({data}) => {
          if(data.success) {
    ...
    const handleDelete = (model) => {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ApiService.delete('/customer/sale/consultations/' + model.id)
            .then(response => {
    ...
    const handleCancel = () => {
      ...
      ApiService.update('/customer/sale/consultations/' + data.room_id, data)
        .then(response => {
    ...
    const handleMassDelete = () => {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          ApiService.delete('/customer/sale/consultations', {data: {consultations: data}})
            .then(response => {
              if(response.data.success){
