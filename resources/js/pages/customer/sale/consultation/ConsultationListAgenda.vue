          ...
          <div>
            <div id="kt_cc_content">
              ...
              <div
                ...
                <div v-if="item.expert" class="d-flex align-items-center flex-grow-1">
                  <div class="symbol symbol-45px me-5">
                    <img :src="`/u/image-${item.expert.id}.jpg`" alt="">
                  </div>
                  <div class="d-flex justify-content-start flex-column">
                    <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">{{ item.expert.name }}</a>
...
export default {
  ...
  setup(){
    ...
    const loadEvents = () => {
      ...
      axios.get('/api/v1/customer/sale/consultations/events', params)
        .then((response) => {
