    ...
    <div class="container">
      ...
      <div class="d-flex flex-column container pt-lg-20">
        ...
        <div class="page-title text-center">
          <h1 class="h1 fs-2hx fw-bolder text-white mb-5">Expert: Cours</h1>
        </div>
        <!--end::Heading-->
      </div>
...
export default {
  ...
  setup(){
    ...
    const loadModels = () => {
      loading.value = true
      ApiService.get('/experts/' + route.params.id + '/formations', {params: params.value})
        .then(({data}) => {
          if(data.success){
