          ...
          <div class="card-body pt-0">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5">
              ...
              <tr
                ...
                <!--begin::Name=-->
                <td>
                  <router-link :to="{name: 'admin.disciplines.view', params:{id: model.id}}" class="d-flex align-items-center">
                    <div class="symbol symbol-45px me-5">
                      <img :src="`/d/image-${model.id}.jpg`" alt="">
                    </div>
                ...
                <td class="text-end">
                  ...
                  <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                      <router-link :to="{name: 'admin.disciplines.view', params: {id: model.id}}" class="menu-link px-3">{{ $t('view') }}</router-link>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                      <router-link :to="{name: 'admin.disciplines.edit', params: {id: model.id}}" class="menu-link px-3">{{ $t('edit') }}</router-link>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
...
export default {
  ...
  setup(){
    ...
    const loadModels = () => {
      ApiService.get('/admin/disciplines', {params: params.value})
        .then(({data}) => {
          if(data.success) {
    ...
    const handleToggle = (index, model) => {
      ApiService.put('/admin/disciplines/' + model.id + '/toggle')
        .then(response => {
    ...
    const handleDelete = (model) => {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ApiService.delete('/admin/disciplines/' + model.id)
            .then(response => {
              if(response.data.success){
                loadModels()
              }
    ...
    const handleMassDelete = () => {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          ApiService.delete('/admin/disciplines', {data: {disciplines: data}})
            .then(response => {
              if(response.data.success){
