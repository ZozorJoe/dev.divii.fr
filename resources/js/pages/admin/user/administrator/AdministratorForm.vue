...
export default {
  ...
  setup(){
    ...
    const create = () => {
      const data = getData()
      ApiService.store('/admin/administrators', data, t('administrator'), initModel, store, t)
    }

    const update = () => {
      const data = getData()
      ApiService.update('/admin/administrators/' + id.value, data, t('administrator'), initModel, store, t)
    }
