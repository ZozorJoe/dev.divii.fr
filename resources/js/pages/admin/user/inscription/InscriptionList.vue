<template>
  ...
  <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <KtToolbar>
      ...
      <a
        href="/admin/download/inscriptions"
        target="_blank"
...
export default {
  ...
  setup(){
    ...
    const loadModels = () => {
      ApiService.get('/admin/inscriptions', {params: params.value})
        .then(({data}) => {
          if(data.success) {
    ...
    const handleDelete = (model) => {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ApiService.delete('/admin/inscriptions/' + model.id)
            .then(response => {
    ...
    const handleMassDelete = () => {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          ApiService.delete('/admin/inscriptions', {data: {inscriptions: data}})
            .then(response => {
              if(response.data.success){
