<template>
  ...
  <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <KtToolbar>
      ...
      <a target="_blank" :href="`/admin/download/invoices/expert`" class="btn btn-sm btn-primary">Télécharger</a>
      <!--end::Button-->
    </KtToolbar>
                ...
                <td>
                  <span
                    ...
                    :class="{
                      ...
                      'badge-light-success': model.status === 'validated',
                      'badge-light-danger': model.status === 'refused'
                    }"
                    class="badge">
                ...
                <td class="text-end">
                  ...
                  <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-200px py-4" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                      <router-link
                        :to="{name: 'admin.experts.invoices.view', params: {id: model.id}}"
...
export default {
  ...
  setup(){
    ...
    const loadModels = () => {
      ApiService.get('/admin/experts/invoices', {params: params.value})
        .then(({data}) => {
          if(data.success) {
    ...
    const handleDelete = (model) => {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ApiService.delete('/admin/experts/invoices/' + model.id)
            .then(response => {
    ...
    const handleMassDelete = () => {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          ApiService.delete('/admin/experts/invoices', {data: {invoices: data}})
            .then(response => {
              if(response.data.success){
