        ...
        <div class="card">
          ...
          <div class="card-body pt-0">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5">
              ...
              <tr v-for="(model, index) in models" :key="model.id" :id="`table-row-${model.id}`">
                <!--begin::Checkbox-->
                <td>
                ...
                <td>
                  <router-link
                    :to="{name: 'admin.experts.view', params:{id: model.id}}"
                ...
                <td class="text-end">
                  ...
                  <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                      <router-link
                        :to="{name: 'admin.experts.edit', params: {id: model.id}}"
                        class="menu-link px-3">
                        {{ $t('edit') }}
                      </router-link>
                    </div>
...
export default {
  ...
  setup(){
    ...
    const loadModels = () => {
      ApiService.get('/admin/experts', {params: params.value})
        .then(({data}) => {
          if(data.success) {
    ...
    const handleToggle = (index, model) => {
      ApiService.put('/admin/experts/' + model.id + '/toggle')
        .then(response => {
    ...
    const handleDelete = (model) => {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ApiService.delete('/admin/experts/' + model.id)
            .then(response => {
              if(response.data.success){
                loadModels()
              }
    ...
    const handleMassDelete = () => {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          ApiService.delete('/admin/experts', {data: {experts: data}})
            .then(response => {
              if(response.data.success){
