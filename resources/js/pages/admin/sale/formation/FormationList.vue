  ...
  <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
      ...
      <div id="kt_content_container" class="container-fluid">
                ...
                <td class="text-end">
                  ...
                  <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-200px py-4" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3 d-none">
                      <router-link
                        :to="{name: 'admin.sale.formations.view', params: {id: model.id}}"
        ...
        <!--begin::Modal-->
        <div v-if="model" class="modal fade show d-block">
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Annulation de cours</h5>
                <!--begin::Close-->
...
export default {
  ...
  setup(){
    ...
    const loadModels = () => {
      ApiService.get('/admin/sale/formations', {params: params.value})
        .then(({data}) => {
          if(data.success) {
    ...
    const handleDelete = (model) => {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ApiService.delete('/admin/sale/formations/' + model.id)
            .then(response => {
    ...
    const handleCancel = () => {
      ...
      ApiService.update('/admin/sale/formations/' + data.room_id, data)
        .then(response => {
          if(response.data.success){
            loadModels()
          }
    ...
    const handleMassDelete = () => {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          ApiService.delete('/admin/sale/formations', {data: {formations: data}})
            .then(response => {
              if(response.data.success){
