    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
      ...
      <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
        <a href="/" class="d-lg-none">
          <img alt="Logo" src="/img/logo-light.svg" class="h-30px">
        </a>
      </div>
      <!--end::Mobile logo-->
      <!--begin::Wrapper-->
      <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
        ...
        <div class="d-flex align-items-stretch" id="kt_header_nav">
          <TimezoneSelect class="mt-4 w-250px" />
        </div>
        <!--end::Navbar-->
        <!--begin::Topbar-->
...
<script>
import KTNotifications from "../../base/header/Notifications";
import ChatDrawerButton from "../../../components/utils/ChatDrawerButton";
export default {
  name: "KtHeader",
  components: {ChatDrawerButton, KTNotifications},
};
</script>
