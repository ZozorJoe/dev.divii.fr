...
namespace App\Http\Controllers\Api\v1\Customer\Sale;

use App\Http\Controllers\Api\ApiController;
use App\Http\Requests\Customer\Sale\RoomRequest;
...
class ConsultationController extends ApiController
{
     ...
     * @return JsonResponse
     */
    public function events(Request $request, Room $room): JsonResponse
    {
        ...
        foreach ($models as $model){
            ...
            $events[$key]['items'][] = [
                'expert' => $expert ? [
                    'id' => $expert->getKey(),
                    'name' => !empty($expert->name) ? $expert->name : $expert->email,
                ] : null,
