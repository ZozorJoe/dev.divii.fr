...
class Reminder30m extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject(__('emails.room.reminder-30m.subject', $data))
            ->markdown('emails.room.reminder-30m', ['user' => $notifiable, 'model' => $this->room, 'data' => $data, ]);
    }
